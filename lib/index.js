  ...
  (0, _createClass3.default)(NpmAutoInstallWebpackPlugin, [{
    ...
    value: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(webpackConfig) {
        var webpackCompiler, webpackStats, _webpackStats$toJson, errors, rawModuleList, areAllModuleValid;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                rawModuleList = errors.map(function (error) {
                ...
                areAllModuleValid = rawModuleList.every(function (it) {
                  return (0, _validateNpmPackageName2.default)(it).validForNewPackages;
                });
              ...
              case 11:
                return _context2.abrupt("return", rawModuleList);
      ...
      function _findMissingModuleList(_x3) {
        return ref.apply(this, arguments);
      }

      return _findMissingModuleList;
    }()
  }, {
    ...
    value: function () {
      ...
      function _installModuleList(_x4) {
        return ref.apply(this, arguments);
      }

      return _installModuleList;
    }()
  }]);
