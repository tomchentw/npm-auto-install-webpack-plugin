...
(0, _tape2.default)("NpmAutoInstallWebpackPlugin normal resolve", function (t) {
...
(0, _tape2.default)("NpmAutoInstallWebpackPlugin nested resolve", function (t) {
  var compiler = (0, _webpack2.default)({
    context: (0, _path.resolve)(__dirname, "../../"),
    entry: {
      client: (0, _path.resolve)(__dirname, "../__fixtures__/nested.fixture.js")
    },
    output: {
      path: __dirname },
    // It will be in MemoryFS :)
